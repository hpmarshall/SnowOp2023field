...
ax2 = axes; hold on
h=scatter(ax2,D5.UTME,D5.UTMN,200,SWE2all,'o','filled')
h=scatter(ax2,D5.UTME,D5.UTMN,200,SWE2all,'ko')
...
title('SURVEY #2: Lidar vegetation height (gray) [m] and snowpit SWE (color) [cm]')
axes(ax2)
