...
ax2 = axes; hold on
h=scatter(ax2,D5.UTME,D5.UTMN,200,dSWE,'o','filled')
h=scatter(ax2,D5.UTME,D5.UTMN,200,dSWE,'ko')

set(h,'LineWidth',3)
axis equal
set(gca,'Clim',[min(dSWE) max(dSWE)])
...
title('\Delta SWE: Lidar vegetation height (gray) [m] and snowpit SWE (color) [cm]')
axes(ax2)
